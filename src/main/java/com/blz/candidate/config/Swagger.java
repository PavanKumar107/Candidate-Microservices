package com.blz.candidate.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.candidate.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("LMS-Candidate",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("LMS-Candidate", "http://blz.candidate", "gvpavangv14@gmail.com"),
                "Apache 2.0",
